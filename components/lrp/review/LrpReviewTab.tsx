...
export function LrpReviewTab({ embeddedInWorkspace = false }: { embeddedInWorkspace?: boolean } = {}) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr]">
      ...
      <div className="p-8 space-y-12">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h1 className="font-heading text-h2 text-secondary">
              LRP Review — {forecast.brand} {forecast.geography}
            </h1>
            <p className="text-sm text-muted mt-1">
              Decision-support visualizations for the long-range plan.
            </p>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              onClick={() => alert("Export Review (PPT) is wired in production.")}
        ...
        <section id="trajectory">
          <NetSalesTrajectory
            viewThroughYear={viewThroughYear}
            versions={versions}
